...
import { getCamelCaseAcronym, matchesCamelCase, performSearch } from "./Search";
...
describe("Search Algorithm", () => {
    ...
    describe("Starts With", () => {
        it("should prioritize starts-with matches", () => {
            const classes = ["com/example/EntityPlayer", "com/example/Player", "com/example/PlayerEntity"];
            const results = performSearch("player", classes);
    ...
    describe("CamelCase Matching", () => {
        ...
        it("should prioritize exact CamelCase acronym matches", () => {
            const classes = ["net/minecraft/client/renderer/RenderType", "net/minecraft/world/entity/player/Player"];
    ...
    describe("Real-world Cases", () => {
        ...
        it("should prioritize shorter class names when scores are equal", () => {
            const classes = ["com/example/PlayerController", "com/example/Player", "com/example/PlayerEntity"];
